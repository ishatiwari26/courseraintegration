...
public class InvitationReader implements ItemReader<Elements> {
	...
	public List<User> inviteUserList() {
		...
		User user1 = new User();
		user1.setExternalId("413861903911");
		user1.setFullName("user113");
		user1.setEmail("abc113@domain.com");

		User user2 = new User();
		user2.setExternalId("413861911196");
		user2.setFullName("user2146");
		user2.setEmail("xyz113@domain.com");
